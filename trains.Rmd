...
row.names(x) <- c("Liberal", "Republican", "Obama disapprove", 
...
# Annoying that there is no (easy!) way to get control of the "Table 1:"
# beginning portion of the caption. Maybe gt makes this easier?
...
kable(ate_tib, digits = 3)

kable(p_tib, digits = 3)
